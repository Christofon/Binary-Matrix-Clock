...
int redVal_header_default = 0;    // Default header color RED
int greenVal_header_default = 255;  // Default header color GREEN
int blueVal_header_default = 255; // Default header color BLUE
